var t;function e(){}Element.prototype.appendAfter=function(t){t.parentNode.insertBefore(this,t.nextSibling)};class s{constructor(t,e){this.$el=document.querySelector(t),this.options=e,this.#t()}#t(){var t;this.$el.innerHTML=(t=this.options,`
    ...
    `),(function(t=[]){if(0===t.length)return document.createElement("div");let s=document.createElement("span");return t.forEach(t=>{let n=document.createElement("button");n.textContent=t.text,n.classList.add("btn"),n.classList.add("btn-outline-info"),n.classList.add("w-100"),n.classList.add("mt-3"),n.onclick=t.handler||e,s.appendChild(n)}),s})(this.options.footerButtons).appendAfter(this.$el.querySelector(".person-info")),document.body.appendChild(this.$el)}clickHandler(t){let{type:e}=t.target.dataset}setContent(t){this.options=t,this.#t()}destroy(){this.$el.removeEventListener("click",this.clickHandler),this.$el.innerHTML=""}}class n{constructor(t,e){this.$el=document.querySelector(t),this.options=e,this.count=0,this.answersUser=[],this.#t(),this.#e()}#t(){this.$el.innerHTML=function(t){let e=t.curQ,s=t.lastQ,n=e/s*100;return`
    <div class="container pt-1">
                <div
                ...
                >
                    ...
                    <small
                        ...
                        >${`\u{412}\u{43E}\u{43F}\u{440}\u{43E}\u{441} ${e} \u{438}\u{437} ${s}`}</small
                    >
                </div>
                <div class="test-info">
    ...
    <div
                ...
                `;class u{constructor(t,e){this.$el=document.querySelector(t),this.options=e,this.#t()}#t(){this.$el.innerHTML=function(t){let e=t.dataOne?t.dataOne.map(i).join(""):"",s=t.dataTwo?t.dataTwo.map(i).join(""):"",n=t.dataOne?"":" d-none";return`
  <div class="container pt-1">
                <h1>\u{420}\u{435}\u{437}\u{443}\u{43B}\u{44C}\u{442}\u{430}\u{442} \u{442}\u{435}\u{441}\u{442}\u{430}</h1>
                <div class="dominant ${n}">
    ...
    `}#e(){this.$btnStart=document.getElementById("start"),this.clickHandler=this.clickHandler.bind(this),this.$el.addEventListener("click",this.clickHandler)}clickHandler(t){let{type:e}=t.target.dataset;"start"===e&&this.startTest()}startTest(){let t=this.isCorrectFields(),e=this.$el.querySelector("#select_gender");delete t.isValid,this.options.onStart&&this.options.onStart(Object.assign(t,{gender:e.value}))}isCorrectFields(){let t=this.$el.querySelector("#input_name"),e=this.$el.querySelector("#input_age");this.$el.querySelectorAll('[data-type="input"]').forEach(t=>{t.classList.remove("is-invalid")});let s=!0,n={isValid:{name:!0,age:!0},name:t.value,age:e.value};if(0===t.value.length&&(n.isValid.name=!1,s=!1),(0>=+e.value||0===e.value.length)&&(n.isValid.age=!1,s=!1),!s){this.#t(n);return}return n}destroy(){this.$el.removeEventListener("click",this.clickHandler),this.$el.innerHTML=""}}("#app",{async onStart(t){await o(t)}});let a=null;async function o(e={}){document.querySelector("#app").innerHTML="",a=new s("#app",{title:"Определение доминирующего нейромедиатора",text:"Первый блок вопросов. Отвечайте на вопросы, основываясь на вашем текущем состоянии.",footerButtons:[{text:"Перейти ко второму блоку",async handler(){await c({blockNumber:2,blockQuestions:t.blockTwo,countQuestions:t.blockTwo.length})}},{text:"Далее",async handler(){await c({blockNumber:1,blockQuestions:t.blockOne,countQuestions:t.blockOne.length})}}]})}let l=null;async function r(e){let s={};l=new n("#app",{blockNumber:e.blockNumber,blockQuestions:e.blockQuestions,countQuestions:e.countQuestions,async onFinishBlockQuestion(e){console.log("Finish test block",e.blockNumber),1===e.blockNumber?(await c({blockNumber:2,blockQuestions:t.blockTwo,countQuestions:t.blockTwo.length}),s.blockOne=await d(e.answers,50)):2===e.blockNumber&&(s.blockTwo=await d(e.answers,[25,25,40,25]),new u("#app",{dataOne:s.blockOne,dataTwo:s.blockTwo}))}})}async function c(t){null===l&&(await r(t),console.log("test init")),2===t.blockNumber&&a.setContent({title:"Определение дефицита нейромедиаторов",text:"Второй блок вопросов. Отвечайте на вопросы, основываясь на вашем текущем состоянии.",footerButtons:[{text:"Далее",handler(){l.setDataBLock(t)}}]})}async function d(t,e){let s=0,n=0,i=0,u=0;return t.forEach((t,a)=>{t&&(a>=0&&a<(e[0]||50)?s++:a>=(e[0]||50)&&a<(e[0]||50)+(e[1]||50)?n++:a>=(e[0]||50)+(e[1]||50)&&a<(e[0]||50)+(e[1]||50)+(e[2]||50)?i++:a>=(e[0]||50)+(e[1]||50)+(e[2]||50)&&a<(e[0]||50)+(e[1]||50)+(e[2]||50)+(e[3]||50)&&u++)}),[{text:"Дофамин",value:s},{text:"Ацетилхолин",value:n},{text:"ГАМК",value:i},{text:"Серотонин",value:u}]}